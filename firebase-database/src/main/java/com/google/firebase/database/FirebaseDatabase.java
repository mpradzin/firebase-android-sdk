...
public class FirebaseDatabase {
     ...
     */
    @NonNull
    public static FirebaseDatabase getInstance(@NonNull String url, @Nullable Socket proxySocket) {
        FirebaseApp instance = FirebaseApp.getInstance();
        if (instance == null) {
            throw new DatabaseException("You must call FirebaseApp.initialize() first.");
        }
        FirebaseDatabase firebaseDatabase = getInstance(instance, url);
        firebaseDatabase.mProxySocket = proxySocket;
    ...
    /**
     * @return The server version for this build of the Firebase Database client
     */
    @NonNull
